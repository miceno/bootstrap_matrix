         ...
         {if $mapv3.mode eq "Pick"}
          ...
          <div class="col-xs-12 col-sm-12 col-md-4">
              ...
              <form action="{g->url}" method="post" id="itemEdit" enctype="application/x-www-form-urlencoded">
                  ...
                  <input type="submit" name="{g->formVar var="form[save]"}" value="{g->text text="Save these coordinates"}"  class="btn btn-primary"/>
                  <input type="submit" name="{g->formVar var="form[cancel]"}" value="{g->text text="Cancel" hint="Discard changes"}"  class="btn btn-link"/>
              </form>
                <!--
              ...
              <strong class="clearfix">{g->text text="Summary"}</strong><p>{$theme.item.summary|markup}</p>
