...
<div class="gbBlock">
    {if $ItemEditItem.can.changePathComponent}
        <div class="form-group {if isset($form.error.pathComponent.invalid)
            ...
            <label class="control-label col-xs-2" for="pathComponent"> {g->text text="Name"}
                <span>{g->text text="(required)"} </label>

            <div class="col-xs-10">

                <div class="input-group">
                    <div class="input-group-addon"><span class="form-control-static">
                    {strip}
                    ...
                    <input id="pathComponent" type="text" size="40" class="form-control form-inline"
    ...
    <div class="form-group">
        ...
        <div class="col-xs-10">
            ...
            {/if}
            <input type="text" id="title" class="form-control" size="60" maxlength="{$ItemEdit.fieldLengths.title}"
    ...
    <div class="form-group">
        ...
        <div class="col-xs-10">
            ...
            <input type="text" class="form-control" id="summary" size="60"
    ...
    <div class="form-group">
        ...
        <div class="col-xs-10">
            <textarea id="keywords" class="form-control" rows="3" cols="60"
    ...
    <div class="form-group">
        <label class="control-label col-xs-2" for="description"> {g->text text="Description"} </label>
        <div class="col-xs-10">
...
<div class="gbBlock form-group">
    <label class="control-label col-xs-2" for="thumbSize"> {g->text text="%s Date and Time" arg1=$ItemEditItem.typeName.0
        postSprintfArg1=$ItemEditItem.typeName.2} </label>
...
<div class="gbBlock form-group">
    <label class="control-label col-xs-2" for="thumbSize"> {g->text text="Thumbnail"} </label>
    <div class="col-xs-10">
        {if $ItemEditItem.can.createThumbnail}
            <input id="thumbSize" type="text" size="6"
