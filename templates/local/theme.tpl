...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{g->theme url='images/favicon/apple-touch-icon.png'}">
    ...
    <link rel="manifest" href="{g->theme url='images/favicon/site.webmanifest'}">
    <link rel="mask-icon" href="{g->theme url='images/favicon/safari-pinned-tab.svg'}" color="#5bbad5">
