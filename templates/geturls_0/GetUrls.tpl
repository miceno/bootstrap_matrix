...
<div class="gbBlock">
  ...
  <p class="gbDescription">
    ...
    <br />
    <input class="form-control" onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot; alt=&quot;{$itemTitle}&quot; /&gt;">
